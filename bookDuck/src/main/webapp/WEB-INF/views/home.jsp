...
<style type="text/css">
	...
	#mainCenter>div{width:48%; float: left; margin-left: 2%; margin-bottom: 100px;}
	/**#mainCenter_left{width:50%;}
	#mainCenter_right{width: 40%}**/
		...
		<div class="innerOuter">
			<div id="mainTop">
				...
				<div class="genre">
					...
					<br/>
					<div id="genreResult">값출력부분<%=sb.toString()%></div>
				</div>
			</div>
